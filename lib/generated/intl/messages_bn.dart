...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "costEfficiency":
            MessageLookupByLibrary.simpleMessage("খরচ-কার্যকারিতা"),
        "costPerKm":
            MessageLookupByLibrary.simpleMessage("প্রতি কিলোমিটারে খরচ"),
        ...
        "editVehicle": MessageLookupByLibrary.simpleMessage("যানবাহন সম্পাদনা"),
        ...
        "enterPaidAmount":
            MessageLookupByLibrary.simpleMessage("পরিশোধিত পরিমাণ টাইপ করুন"),
        "enterTotalVolume":
            MessageLookupByLibrary.simpleMessage("মোট ভলিউম টাইপ করুন"),
        "errorImportingData":
            MessageLookupByLibrary.simpleMessage("ডেটা ইম্পোর্ট করতে সমস্যা: "),
        "errorReadingCSVFile":
            MessageLookupByLibrary.simpleMessage("সিএসভি ফাইল পড়তে সমস্যা: "),
        "export": MessageLookupByLibrary.simpleMessage("এক্সপোর্ট"),
        "exportAppSettings":
            MessageLookupByLibrary.simpleMessage("অ্যাপ সেটিংস এক্সপোর্ট করুন"),
        "exportRefuelingData": MessageLookupByLibrary.simpleMessage(
            "রিফুয়েলিং ডেটা এক্সপোর্ট করুন"),
        "exportToCSV":
            MessageLookupByLibrary.simpleMessage("সিএসভি-তে এক্সপোর্ট করুন"),
        "exportVehicleInformation":
            MessageLookupByLibrary.simpleMessage("গাড়ির তথ্য এক্সপোর্ট করুন"),
        "failedToExport":
            MessageLookupByLibrary.simpleMessage("এক্সপোর্ট করতে ব্যর্থ: "),
        "fileStorageOption":
            MessageLookupByLibrary.simpleMessage("ফাইল স্টোরেজ অপশন"),
        ...
        "fuelPriceRate":
            MessageLookupByLibrary.simpleMessage("জ্বালানির দামের হার (টাকা)"),
        ...
        "scooterOrMoped":
            MessageLookupByLibrary.simpleMessage("স্কুটার/ভেসপা/মপেড"),
        "secondaryFuelCapacity": MessageLookupByLibrary.simpleMessage(
            "মাধ্যমিক জ্বালানির ধারণক্ষমতা"),
        "secondaryFuelType":
            MessageLookupByLibrary.simpleMessage("মাধ্যমিক জ্বালানির প্রকার"),
        "selectCSVFile":
            MessageLookupByLibrary.simpleMessage("সিএসভি ফাইল নির্বাচন করুন"),
        "selectDataToExport": MessageLookupByLibrary.simpleMessage(
            "এক্সপোর্ট করার জন্য ডেটা নির্বাচন করুন:"),
        "selectedFile": MessageLookupByLibrary.simpleMessage("নির্বাচিত ফাইল"),
        "setAsDefault":
            MessageLookupByLibrary.simpleMessage("ডিফল্ট হিসাবে সেট করুন"),
        "settings": MessageLookupByLibrary.simpleMessage("সেটিংস"),
        "settingsSaved":
            MessageLookupByLibrary.simpleMessage("সেটিংস সংরক্ষিত হয়েছে।"),
